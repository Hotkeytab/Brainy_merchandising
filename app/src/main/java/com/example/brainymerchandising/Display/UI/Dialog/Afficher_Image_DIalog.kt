...
class Afficher_Image_DIalog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(Flag == 0){
            ...
            val_quantite.text = Editable.Factory.getInstance().newEditable(listaImage!![position].text)
        ...
        if(Flag == 1){
            ...
            }else {(display_fragment.activity as PrimeActivity).tab_Image!!.get(size).text=""}
                dismiss()}
